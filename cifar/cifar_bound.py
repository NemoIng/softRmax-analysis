...
def plot_decision_boundary(net=None, num_classes=10, epoch=15, function='softRmax', n_samples=200, 
    ...
    testloader = td.DataLoader(test_data, batch_size=64, shuffle=False, num_workers=1)
    total_acc = class_acc(testloader, net, num_classes, classes)

    title = f'{function} - CIFAR10 ({total_acc})'
